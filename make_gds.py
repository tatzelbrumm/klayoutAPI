...
# Draw shapes
top.shapes(l_active).insert(pya.Box(290, -380, 290+w, 380))
top.shapes(l_po).insert(    pya.Box(-150, -150, 470+w, 150))
top.shapes(l_co).insert(    pya.Box(-80,  -80,   80,  80))
top.shapes(l_m1).insert(    pya.Box(-80, -130,   80, 130))
top.shapes(l_pimp).insert(  pya.Box(-10, -560,  590+w, 560))
top.shapes(l_nwell).insert( pya.Box(-30, -790,  610+w, 790))
